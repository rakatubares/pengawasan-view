    ...
    <div class="wrapper my-form">
        <CForm class="pt-3">
            ...
            <div v-if="data.detail.type == 'nhin-orang'">
                ...
                <CRow>
                    <label class="w-100 pl-3 pt-2 mb-0" for="tanggal_berangkat">Waktu Keberangkatan</label>
                    <CCol md="3" sm="12">
                        <div class="form-group">
                            <date-picker 
                ...
                <CRow>
                    <label class="w-100 pl-3 pt-2 mb-0" for="tanggal_datang">Waktu Kedatangan</label>
                    <CCol md="3" sm="12">
                        <div class="form-group">
                            <date-picker 
