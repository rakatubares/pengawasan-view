<template>
    <div class="wrapper my-form">
        ...
        <CForm class="pt-3">
            ...
            <CRow>
                <label 
                    class="w-100 pl-3 pt-2 mb-0" 
                    for="tanggal_mulai_penindakan"
                >Tanggal/Waktu Mulai Penindakan</label>
                <CCol md="3" sm="12">
            ...
            <CRow>
                <label 
                    class="w-100 pl-3 pt-2 mb-0" 
                    for="tanggal_selesai_penindakan"
                >Tanggal/Waktu Selesai Penindakan</label>
                <CCol md="3" sm="12">
                    <div class="form-group">
                        <date-picker 
