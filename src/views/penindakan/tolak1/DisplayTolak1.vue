	...
	<div class="wrapper display-tolak1">
		<CRow>
			<CCol class="mt-3 mx-2" md="12">
				<CRow>
					<CCol class="pb-1">
						<h4>{{ disp_no_ba_tolak1 }}</h4>
					</CCol>
				</CRow>
				<CRow>
					<CCol class="pt-1 pb-3">
						<h5>{{ disp_tgl_ba_tolak1 }}</h5>
					</CCol>
				</CRow>
				<CRow class="mb-1">
...
export default {
	...
	computed: {
		disp_no_ba_tolak1() { return this.data_doc.no_dok_lengkap || '-' },
		disp_tgl_ba_tolak1() { return this.data_doc.tanggal_dokumen || '-' },
