...
class PdfNhi extends Pdf {
	...
	generatePdf() {
		...
		// Uraian
		let txt_tujuan = this.data.tujuan.jabatan || ''
		...
		console.log('TXT DIM - OPENING', this.pdf.getTextDimensions(txt_op, {align: 'justify', maxWidth: 185}))
		...
		this.pdf.text(':', this.props.ind.cln3, this.ln)
		let txt_kantor = this.data.kantor.nama_kantor || ''
		let arr_kantor = converters.array_text(txt_kantor, 45)
		this.pdf.text(arr_kantor, this.props.ind.val3, this.ln)
		this.ln += this.props.font.height*(arr_kantor.length)

		console.log('txt dim - test', this.pdf.getTextDimensions('Text'))
		console.log('txt dim - kantor', this.pdf.getTextDimensions(arr_kantor))

		// // CONSTRUCT BARANG
		// let height_barang = 1
		// let uraian_barang = ''
		// // if (this.data.objek) {
		// 	if (this.data_barang.length > 1) {
		// 		uraian_barang = 'LIHAT LAMPIRAN'
		// 	} else {
		// 		let txt_barang = `${this.data_barang.item[0].jumlah_barang} `
		// 			+ `${this.data_barang.item[0].
		...
		// 		// Tabel barang
		// 		this.tabelBarang(this.data_barang)
		// 	}	
		// // }satuan.satuan} `
		// 			+ `${this.data_barang.item[0].uraian_barang} `
		...
		// this.pdf.text(':', this.props.ind.cln3, this.ln)
		// let txt_dok_exim = detail_type == 'nhi-exim' 
		...
		// 	var txt_sarkut_exim = `${data_detail.nama_sarkut || '-'} Voy/Flight/No. Pol: ${data_detail.no_flight_trayek || '-'}`
		...
		// this.pdf.text(':', this.props.ind.cln3, this.ln)
		// let txt_awb_exim = detail_type == 'nhi-exim' 
		...
		// this.pdf.text(':', this.props.ind.cln3, this.ln)
		// let txt_koli_exim = detail_type == 'nhi-exim' ? (detail_data.merek_koli || '') : ''
		...
		// this.pdf.text(':', this.props.ind.cln3, this.ln)
		// let txt_importir_exim = detail_type == 'nhi-exim' ? (detail_data.entitas.data.nama || '') : ''
		...
		// this.pdf.text(':', this.props.ind.cln3, this.ln)
		// let txt_lain_exim = detail_type == 'nhi-exim' ? (detail_data.data_lain_exim || '') : ''
