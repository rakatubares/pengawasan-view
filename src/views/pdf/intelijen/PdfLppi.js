...
class PdfLppi extends Pdf
{
    ...
    generateText() 
    {
        ...
        this.checkbox = {}
        this.checkbox.internal = this.data.flag_info_internal
            ? this.checked_checkbox : this.empty_checkbox
        this.checkbox.eksternal = this.data.flag_info_eksternal
            ? this.checked_checkbox : this.empty_checkbox
        this.checkbox.analisis = this.data.flag_analisis
            ? this.checked_checkbox : this.empty_checkbox
        this.checkbox.arsip = this.data.flag_arsip
            ? this.checked_checkbox : this.empty_checkbox
