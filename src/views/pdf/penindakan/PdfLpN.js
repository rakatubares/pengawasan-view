...
class PdfLpN extends PdfPenindakan {
	...
	writeText()
	{
		...
		this.write(':', inds.cln)
		this.write(this.txt.locus, inds.txt, inds.txt, undefined, undefined, this.page_width-inds.lbl2)
		...
		this.write(':', inds.cln)
		this.write(data_sarkut.jenis_sarkut, inds.txt, inds.txt, inds.txt, undefined, undefined, this.page_width-inds.lbl2)
